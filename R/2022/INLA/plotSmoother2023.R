...
dir.fig <-  gsub(dir, pattern="results", replacement="figures")
...
write.table(fixed_effect, file=paste0(dir.fig,"/fixed_effects_",name,subfamily, ".txt"), row.names=T, sep="\t", dec=".")
